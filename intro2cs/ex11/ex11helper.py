...
Line = namedtuple('Point', ['p1', 'p2'])


class Graph:
    """
    An object from class Graph with only one public function:
    plot_line: plot a line to the screen
    """
    def __init__(self, top, minX=-10, minY=-10, maxX=10, maxY=10):
        """
        Init a graph
        Expect a gui object and graph limits
        """
        self.__top = top
    ...
    def plot_line(self, p1, p2, c):
        ...
        Don't do nothing in case of a line not within the screen limits
        """
        line = (p1, p2)
    ...
    # Test if all the points in the segment are withing the graph limits
