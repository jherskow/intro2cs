...
class ex5GUI:
    ...
    def read_prices_GUI(self):
        ...
        and write the resultant dictinoary to the screen
        '''
        item_idx = self.store_idx_GUI.get()-1
        try:   
    ...
    def filterGUI(self):
        ...
        with the filtered txt and then update the store frame
        '''
    ...
    def print_to_screen(self):
        '''
        Present a srote in the store frame
        using its textual representation and its name
    ...
    def create_basket_canvas(self):
        '''
        Create a canvas wfor the basket table -
    ...
    def get_prices_counts_best_GUI(self):
        ...
        Refresh the table sums based on these results.
        '''
    ...
    def add_basket_GUI(self):
        ...
        using the selected text and print the basket table
        '''
    ...
    def print_basket(self):
        ''' create the table in the basket canvas and print it and its sum'''
